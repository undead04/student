...
import homeworkServer, { IHomeworkModel } from "../../servers/homeworkServer";
...
const HomeworkDetail = () => {
  ...
  useEffect(() => {
    document.title = "Xem chi tiết bài tập về nhà";
    const fetchData = async () => {
      try {
        if (id) {
          const response = await homeworkServer.get(id).then((res) => res.data);
          if (response) {
        ...
        <div className="container">
          <div className="row">
            <div className="col text-end">
              <Link to={"/homework"} className="btn btn-success">
